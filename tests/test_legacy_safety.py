...
class LegacySafetyTests(unittest.TestCase):
    CANONICAL_SOTLAS_MODULES = {
        ...
        "kernel/src/drivers/xhci_start.sotlas", "kernel/src/drivers/xhci_port.sotlas",
        "kernel/src/drivers/xhci_protocol.sotlas", "kernel/src/drivers/xhci_port_reset.sotlas",
