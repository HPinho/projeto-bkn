...
class LegacySafetyTests(unittest.TestCase):
    CANONICAL_SOTLAS_MODULES = {
        "kernel/src/main.st",
        "kernel/src/graphics_engine.st",
        "kernel/src/baken_rasterizer.st",
        "kernel/src/baken_animation.st",
        "kernel/src/baken_ui_oop.st",
        "kernel/src/window_manager.st",
        "kernel/src/desktop_shell.st",
        "kernel/src/desktop_compositor.st",
    }
