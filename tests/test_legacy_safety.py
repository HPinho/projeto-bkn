...
class LegacySafetyTests(unittest.TestCase):
    CANONICAL_SOTLAS_MODULES = {
        ...
        "kernel/src/install_engine.sotlas",
        ...
        "kernel/src/memory/direct_map.sotlas", "kernel/src/memory/page_table_arena.sotlas",
        "kernel/src/memory/page_table_writer.sotlas", "kernel/src/memory/page_table_mapper.sotlas",
        "kernel/src/memory/page_table_builder.sotlas", "kernel/src/memory/dma.sotlas",
