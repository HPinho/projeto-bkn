...
class LegacySafetyTests(unittest.TestCase):
    CANONICAL_SOTLAS_MODULES = {
        ...
        "kernel/src/drivers/ahci_runtime.sotlas", "kernel/src/drivers/ahci_block_read.sotlas",
        "kernel/src/drivers/ahci_block_io.sotlas", "kernel/src/drivers/nvme.sotlas",
        ...
        "kernel/src/drivers/xhci_address.sotlas", "kernel/src/drivers/xhci_evaluate_context.sotlas",
        "kernel/src/drivers/xhci_ep0.sotlas", "kernel/src/drivers/xhci_descriptor.sotlas",
        "kernel/src/drivers/xhci_configuration.sotlas", "kernel/src/drivers/xhci_hid_context.sotlas",
        "kernel/src/drivers/xhci_configure_endpoint.sotlas",
        "kernel/src/drivers/xhci_set_configuration.sotlas", "kernel/src/drivers/xhci_hid_report.sotlas",
        ...
        "kernel/src/storage/gpt_redundancy.sotlas", "kernel/src/storage/foundation_probe.sotlas",
        "kernel/src/storage/fat32.sotlas", "kernel/src/storage/fat32_path.sotlas",
        "kernel/src/storage/crc32.sotlas",
        ...
        "kernel/src/memory/active_page_tables.sotlas",
        ...
        "kernel/src/memory/transition_image_wx.sotlas", "kernel/src/memory/transition_framebuffer_map.sotlas",
        "kernel/src/memory/transition_page_tables.sotlas", "kernel/src/memory/cutover_prepare.sotlas",
        ...
        "kernel/src/arch/x86_64/serial.sotlas", "kernel/src/arch/x86_64/post_cutover.sotlas",
    }
