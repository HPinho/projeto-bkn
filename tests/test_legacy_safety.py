...
class LegacySafetyTests(unittest.TestCase):
    CANONICAL_SOTLAS_MODULES = {
        ...
        "kernel/src/memory/transition_stack_map.sotlas", "kernel/src/memory/transition_image_map.sotlas",
        "kernel/src/memory/transition_page_tables.sotlas", "kernel/src/memory/cutover_plan.sotlas",
