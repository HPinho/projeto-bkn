...
FORBIDDEN = re.compile(r'\b(?:baken_efi_\w*|uefi_\w*|Efi\w*|EFI_\w*|BootServices|RuntimeServices|SystemTable|Stall|LocateProtocol|ReadBlocks|WriteBlocks|baken_runtime\w*)\b')
