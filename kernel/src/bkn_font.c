/*
 * Baken OS - Tabela de Glifos 8x16 Nítida e Perfeita (Padrão IBM VGA / CP437 Standard)
 * Garante legibilidade impecável para caracteres ASCII (32 a 126).
 */
...
const uint8_t bkn_font8x16[128][16] = {
    ...
    ['0'] = {0x00,0x00,0x3C,0x66,0xC3,0xE3,0xD3,0xDB,0xCF,0xC7,0x66,0x3C,0x00,0x00,0x00,0x00},
    ...
    ['@'] = {0x00,0x00,0x7C,0xC6,0xDE,0xD6,0xD6,0xD6,0xDE,0xC0,0xC6,0x7C,0x00,0x00,0x00,0x00},
    ...
    ['G'] = {0x00,0x00,0x3C,0x66,0xC3,0xC0,0xC0,0xCE,0xC6,0xC6,0x66,0x3E,0x00,0x00,0x00,0x00},
    ...
    ['b'] = {0x00,0xE0,0x60,0x60,0x60,0x7C,0x66,0x66,0x66,0x66,0x66,0x7C,0x00,0x00,0x00,0x00},
    ['c'] = {0x00,0x00,0x00,0x00,0x00,0x7C,0xC6,0xC0,0xC0,0xC0,0xC6,0x7C,0x00,0x00,0x00,0x00},
    ['d'] = {0x00,0x1C,0x0C,0x0C,0x0C,0x7C,0xCC,0xCC,0xCC,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00},
    ['e'] = {0x00,0x00,0x00,0x00,0x00,0x7C,0xC6,0xFE,0xC0,0xC0,0xC6,0x7C,0x00,0x00,0x00,0x00},
    ['f'] = {0x00,0x1C,0x36,0x30,0x30,0xFC,0x30,0x30,0x30,0x30,0x30,0x78,0x00,0x00,0x00,0x00},
    ['g'] = {0x00,0x00,0x00,0x00,0x00,0x76,0xCC,0xCC,0xCC,0xCC,0x7C,0x0C,0xCC,0x78,0x00,0x00},
    ['h'] = {0x00,0xE0,0x60,0x60,0x60,0x7C,0x66,0x66,0x66,0x66,0x66,0xE7,0x00,0x00,0x00,0x00},
    ['i'] = {0x00,0x18,0x18,0x00,0x00,0x38,0x18,0x18,0x18,0x18,0x18,0x3C,0x00,0x00,0x00,0x00},
    ['j'] = {0x00,0x0C,0x0C,0x00,0x00,0x1C,0x0C,0x0C,0x0C,0x0C,0x0C,0x0C,0xCC,0x78,0x00,0x00},
    ['k'] = {0x00,0xE0,0x60,0x60,0x60,0x66,0x6C,0x78,0x78,0x6C,0x66,0xE7,0x00,0x00,0x00,0x00},
    ['l'] = {0x00,0x38,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x3C,0x00,0x00,0x00,0x00},
    ['m'] = {0x00,0x00,0x00,0x00,0x00,0xFE,0xDB,0xDB,0xDB,0xDB,0xDB,0xDB,0x00,0x00,0x00,0x00},
    ...
    ['r'] = {0x00,0x00,0x00,0x00,0x00,0xDC,0x66,0x66,0x60,0x60,0x60,0xF0,0x00,0x00,0x00,0x00},
    ['s'] = {0x00,0x00,0x00,0x00,0x00,0x7C,0xC6,0x60,0x38,0x0C,0xC6,0x7C,0x00,0x00,0x00,0x00},
    ['t'] = {0x00,0x10,0x30,0x30,0xFC,0x30,0x30,0x30,0x30,0x30,0x36,0x1C,0x00,0x00,0x00,0x00},
    ...
    ['y'] = {0x00,0x00,0x00,0x00,0x00,0xC3,0xC3,0xC3,0xC3,0xC3,0x7F,0x03,0x06,0x3C,0x00,0x00},
